import pandas as pd
data = pd.read_csv("C:/Users/test/Downloads/Rahul_data/MCA_ project/Heart_Disease_pred/Heart-Disease-Prediction-with-GUI-main/Heart_disease _pred/heart.csv")
data.isnull().sum()
